		...
		<div id="list-equipe" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="nome" title="${message(code: 'equipe.nome.label', default: 'Nome')}" />
				...
				<g:each in="${equipeInstanceList}" status="i" var="equipeInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${equipeInstance.id}">${fieldValue(bean: equipeInstance, field: "nome")}</g:link></td>
