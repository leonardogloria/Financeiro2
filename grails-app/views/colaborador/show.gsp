	...
	<body>
		...
		<div id="show-colaborador" class="content scaffold-show" role="main">
			...
			<ol class="property-list colaborador">
				...
				<g:if test="${colaboradorInstance?.nome}">
				<li class="fieldcontain">
					<span id="nome-label" class="property-label"><g:message code="colaborador.nome.label" default="Nome" /></span>
					
						<span class="property-value" aria-labelledby="nome-label"><g:fieldValue bean="${colaboradorInstance}" field="nome"/></span>
