...
<html>
	...
	<body>
		...
		<div id="edit-colaborador" class="content scaffold-edit" role="main">
			...
			<g:hasErrors bean="${colaboradorInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${colaboradorInstance}" var="error">
				<li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
				</g:eachError>
			</ul>
			</g:hasErrors>
			<g:form url="[resource:colaboradorInstance, action:'update']" method="PUT" >
				<g:hiddenField name="version" value="${colaboradorInstance?.version}" />
				<fieldset class="form">
